                                                        ...
                                                        <div class="card-body ">
                                                            ...
                                                            <table id="dataTableExample" class="table ">
                                                                ...
                                                                @foreach ($tasks as $task)
                                                                    <tr>
                                                                        <td>                                            
                                                                            <a href="{{ route('task.toggleStar',$task->id) }}" class="d-flex flex-row-reverse mt-3" > @if( $project->toggleStar == 1) <i class="fa-solid fa-star" style="color: #FFD43B;"></i> @else <i class="fa-regular fa-star" ></i>  @endif </a>                                    
                                                                        </td>
