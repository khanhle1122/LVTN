                            ...
                            <div class="mt-3 perfect-scrollbar-example-x">
                                ...
                                <div class="col-2 ms-3 mt-3 p-1 pb-3" style="width:170px; display: inline-block;">
                                    ...
                                    <div class="card_k border shadow ">
                                        <div class=" ">
                                            <a href="{{ route('report.detail',$project->id) }}">
                                            ...
                                            <div class="pt-3 ps-3 pb-3">
                                                <div class="ms-1"><a class="text-dark" href="{{ route('report.detail',$project->id) }}">Mã: {{ $project->projectCode }}</a></div>
                                                <div class="ms-1"><a class="text-dark" href="{{ route('report.detail',$project->id) }}">{{ $project->projectName }}</a></div>
                                                @if($project->status==1)
                        ...
                        <div class="mt-5">
                            ...
                            <div class="mt-3 perfect-scrollbar-example-x">
                                ...
                                <div class="col-2 ms-3 mt-3 p-1 pb-3" style="width:170px; display: inline-block;">
                                    ...
                                    <div class="card_k border shadow ">
                                        <div class=" ">
                                            <a href="{{ route('report.detail',$projected->id) }}">
