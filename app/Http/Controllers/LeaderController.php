...
class LeaderController extends Controller
{
    public function index(){
        ...
        return view('leader.index_leader',compact('projects','divisions','notifications','unreadMessagesCount'));
    }
    public function index_profile(){
        ...
        return view('leader.profile-leader',compact('userClass','notifications','unreadMessagesCount'));
    }
