...
class ChatController extends Controller
{
    ...
    public function index_leader()
    {
        ...
        $unreadMessagesCount = Message::whereHas('chatRoom', function ($query) {
            ...
            ->where('is_read', 0)
            ->count();
        return view('leader.chat', compact('chatRooms','notifications','unreadMessagesCount','users'));
    }
    public function index_supervisor()
    {
        ...
        $unreadMessagesCount = Message::whereHas('chatRoom', function ($query) {
            ...
            ->where('is_read', 0)
            ->count();
        return view('supervisor.chat', compact('chatRooms','notifications','unreadMessagesCount','users'));
    }
