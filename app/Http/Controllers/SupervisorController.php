...
class SupervisorController extends Controller
{
    public function index(){
        ...
        return view('supervisor.index',compact('projects','divisions','notifications','unreadMessagesCount'));
    }
    public function index_profile(){
        ...
        $projects =WorkingProject::where('user_id',$user->id)->get();
        return view('supervisor.profile-supervisor',compact('projects','userClass','notifications','unreadMessagesCount'));
    }
